 ...
 *	-- hgb
 *	Added yet another loglevel, explicitly for logging blocked access.
 *	-- henrik
 *
 * Level	Description
 * -----	-----------
 ...
 *
 * LOG_BLOCK	This is for logging blocking of clients due to filter rules.
 *
...
#define LOG_BLOCK     9         /* extra to log blocking of clients due to filter */
