...
#  define CONFIG_ENV_OFFSET ((*((volatile unsigned int *)GLOBAL_SOFTWARE2) & 0x1) ? CONFIG_ENV_OFFSET2 : CONFIG_ENV_OFFSET1)
# endif
# if defined CONFIG_ENV_OFFSET_REDUND1 && defined CONFIG_ENV_OFFSET_REDUND2
#  undef CONFIG_ENV_OFFSET_REDUND
#  define CONFIG_ENV_OFFSET_REDUND ((*((volatile unsigned int *)GLOBAL_SOFTWARE2) & 0x1) ? CONFIG_ENV_OFFSET_REDUND2 : CONFIG_ENV_OFFSET_REDUND1)
# endif
